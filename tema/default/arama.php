		 ...
		 <div class="content-grids">
			 <div class="col-md-8 content-main">
				 <div class="content-grid">
				 	Arama Sorgusu: <?php echo $_GET['sorgu'];?>
				 <?php foreach ($sorgu as $s):?>
					...
					<?php endforeach;?>
					<?php sayfalama($icerik->getToplamIcerik(),$icerik->getIcerikSayisi(),$icerik->getSayfa(),url.'/index.php?yer=arama&sorgu='.$_GET['sorgu'].'&sayfa=(:num)');?> 
				 </div>
			  </div>
